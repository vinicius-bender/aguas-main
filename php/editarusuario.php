<?php
    ...
    $query = mysqli_query($link,"SELECT * FROM USUARIO WHERE idUsuario = $idUsuario");
...
<body onload="valorSelecionado()">
    ...
    <div class="row m-0 d-flex justify-content-center">
            <div class="gray container mx-5 rounded col-4 py-3 my-5">
                <form action="c_editarusuario.php" class="mx-3 mt-2" method="post">
                    <h1>Editar usuario</h1>
                    <p>Altere as informações deste usuario especifico <?php echo $nivel?></p>
                    <div class="mt-3">
                        <label class="form-lable" for="email">Email</label>
                        <input class="form-control" value="<?php echo $email?>" placeholder="Email" type="email" name="email">
                    </div>
                    <div class="mt-3">
                        <label class="form-lable" for="senha">Senha</label>
                        <div class="d-flex">
                            <input id="senha1" class="form-control d-flex" placeholder="Senha" value="<?php echo $senha?>" type="password" name="senha">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex">
                            <input id="senha2" class="form-control d-flex pl-5" placeholder="Senha" value="<?php echo $senha?>" type="password" name="senha2">
                    ...
                    <div class="mt-3">
                        ...
                        <input class="form-control" value="<?php echo $nome?>" placeholder="Nome" type="text" name="nome">
                    </div>
                    <div class="my-3">
                        <label class="form-lable" for="matricula">Matrícula</label>
                        <input class="form-control" value="<?php echo $matricula?>" placeholder="Matrícula" type="text" class="matricula" name="matricula">
                    </div>
                    <div class="my-3">
                        <label class="form-lable" for="acesso">Nível de acesso</label>
                        <select class="form-control" id="option" name="nivel">
                            <option id="valor1" value="1">Nivel 1</option>
                            <option id="valor2" value="2">Nivel 2</option>
                        </select>
                        <p class="mt-2">
                    ...
                    <input value="<?php echo $idUsuario?>" hidden name="idUsuario">
    ...
    <script>
        ...
        var valor1 = option.options[0];
        var valor2 = option.options[1];
        ...
        function valorSelecionado(){
            if(<?php echo $nivel ?> == 2){
                valor2.selected = true;
            }else if(<?php echo $nivel ?> == 1){
                valor1.selected = true;
            }
        }
    </script>
</body>
